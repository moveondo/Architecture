  ...
  <div class="navigationBar">
    ...
    <nav>
      <ul>
        ...
        <li><router-link exact to="/DataBinging">数据绑定</router-link></li>
        <li><router-link exact to="/SpreadStyle">样式</router-link></li>
        <li><router-link exact to="/OutLine">分组</router-link></li>
		<li><router-link exact to="/ExcelIO">Excel导入导出</router-link></li>
		<li><router-link exact to="/BindAndValidation">校验与重置行数</router-link></li>
		<li><router-link exact to="/User">用户demo</router-link></li>
